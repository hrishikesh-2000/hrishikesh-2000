...
- Built and optimized end-to-end ETL pipelines for the insurance domain, including schema modeling and data validation.
- Developed scalable data pipelines using Azure Data Factory and Databricks for large-scale ingestion and transformation.
- Implemented Medallion Architecture and designed curated business views in SQL to support analytics.
